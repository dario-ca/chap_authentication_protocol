...
\lettrine{\inputencoding{latin1}{A}\inputencoding{latin9}}authentication
is a procedure that confirms the truth of an entity which intends
...
\lettrine{T}he protocol is a Point-to-Point Challenge-Handshake
...
\lettrine{\inputencoding{latin1}{A}\inputencoding{latin9}} client-server
configuration has been implemented using Python programming language.
...
\textcolor{red}{DECIDER CHE FIGURE METTERE MAGARI DEGLI SCREENSHOTS}
...
valid client and the server. In the figure below we can analyze how
a eavesdropping attack is avoided by the CHAP protocol.

\textcolor{red}{FIGURA EAVESDROPPING 1}
...
\textcolor{red}{FIGURA EAVESDROPPING 2}

In the figure, Eve successfully eavesdropped the answer the client
